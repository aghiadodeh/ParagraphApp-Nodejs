...
module.exports = {
    init: (max = 20) => {
        ...
        const limiter = rateLimit({
            ...
            keyGenerator: function (req /*, res*/) { // allows to create custom keys (by default user IP is used)
                return req.ip;
            },
            handler: function (req, res /*, next*/) {
                ...
                return res.status(limiterOptions.statusCode).json(ResponseHelper.badResponse(limiterOptions.message));
            },
        });
        return limiter;
    },
